...
Body text:       font-size="22-24" max ~50 chars
...
<text x="200" y="225" text-anchor="start" fill="#6366f1" font-weight="bold" font-size="26">1.</text>
<text x="240" y="225" text-anchor="start" fill="#fff" font-size="24">Step description here</text>
...
<text x="550" y="180" text-anchor="middle" fill="#6366f1" font-weight="bold" font-size="26">KEY CONCEPT</text>
<text x="550" y="225" text-anchor="middle" fill="#fff" font-size="22">One-line summary of what's being tested</text>
...
```svg
<!-- WRONG: 60-char text at font-size 28 in a 400px-wide box -->
<rect x="100" y="200" width="400" height="100"/>
<text x="300" y="250" font-size="28">This text is way too long to fit inside this narrow box</text>

<!-- RIGHT: Split into two lines, reduce font size -->
<rect x="100" y="200" width="400" height="120"/>
<text x="300" y="245" font-size="22">This text is split across</text>
<text x="300" y="275" font-size="22">two properly sized lines</text>
```
