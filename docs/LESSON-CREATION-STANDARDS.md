...
```javascript
{
    ...
    visual: {
        ...
        svg: `<svg viewBox="0 0 1100 1100" class="lesson-visual">
            ...
            <text x="550" y="180" text-anchor="middle" fill="#6366f1" font-weight="bold" font-size="22">KINTSUGI</text>
            <text x="550" y="225" text-anchor="middle" fill="#fff" font-size="18">Broken pottery repaired with gold</text>
            <text x="550" y="260" text-anchor="middle" fill="#888" font-size="16">Cracks become the most beautiful part</text>
        </svg>`,
...
```javascript
{
    ...
    visual: {
        ...
        svg: `<svg viewBox="0 0 1100 1100" class="lesson-visual">
            ...
            <text x="150" y="220" text-anchor="start" fill="#fff" font-style="italic" font-size="22">"We can be blind to the obvious,</text>
            <text x="150" y="265" text-anchor="start" fill="#fff" font-style="italic" font-size="22">and we are also blind to our blindness."</text>
            <text x="850" y="320" text-anchor="end" fill="#8b5cf6" font-size="18">— Daniel Kahneman</text>
        </svg>`,
...
```javascript
{
    ...
    visual: {
        ...
        svg: `<svg viewBox="0 0 1100 1100" class="lesson-visual">
            <rect x="0" y="0" width="1100" height="1100" fill="#1a1a2e"/>
            <text x="550" y="55" text-anchor="middle" fill="#ffd700" font-weight="bold" font-size="36">YOUR PRACTICE</text>
            <text x="550" y="100" text-anchor="middle" fill="#888" font-size="23">Five steps to your first forest bath</text>
            ...
            <text x="240" y="220" text-anchor="start" fill="#fff" font-size="18">Find your spot</text>
            ...
            <text x="240" y="340" text-anchor="start" fill="#fff" font-size="18">Set aside 20 minutes</text>
            ...
            <text x="240" y="460" text-anchor="start" fill="#fff" font-size="18">Walk at half your normal speed</text>
            ...
            <text x="240" y="580" text-anchor="start" fill="#fff" font-size="18">Engage all five senses</text>
            ...
            <text x="240" y="700" text-anchor="start" fill="#fff" font-size="18">Stop and sit for 5 minutes</text>
        </svg>`,
...
### Text Size Standards
```
Main title:      font-size="36"    max ~27 chars    y="55"
Subtitle:        font-size="23"    max ~38 chars    y="100"
Section header:  font-size="24-26" max ~45 chars    bold, colored
Body text:       font-size="20-22" max ~55 chars    fill="#fff"
Secondary text:  font-size="16"    max ~60 chars    fill="#888"
Small text:      font-size="14"    max ~65 chars
```
...
<text x="550" y="250" text-anchor="middle" fill="#6366f1" font-weight="bold" font-size="22">SECTION TITLE</text>
<!-- Body text with 40px line spacing -->
<text x="550" y="295" text-anchor="middle" fill="#fff" font-size="18">First line of content here</text>
<text x="550" y="335" text-anchor="middle" fill="#888" font-size="16">Second line with smaller text</text>
```
...
<text x="290" y="265" text-anchor="middle" fill="#fff" font-size="18">Content line 1</text>
<text x="290" y="300" text-anchor="middle" fill="#888" font-size="16">Content line 2</text>
...
<text x="810" y="265" text-anchor="middle" fill="#fff" font-size="18">Content line 1</text>
<text x="810" y="300" text-anchor="middle" fill="#888" font-size="16">Content line 2</text>
```
...
<text x="230" y="265" text-anchor="middle" fill="#fff" font-size="16">Description</text>
...
<text x="550" y="265" text-anchor="middle" fill="#fff" font-size="16">Description</text>
...
<text x="870" y="265" text-anchor="middle" fill="#fff" font-size="16">Description</text>
```

### Four-Box Grid
```svg
<rect x="80" y="170" width="440" height="160" rx="20" fill="rgba(99,102,241,0.12)" stroke="#6366f1" stroke-width="2"/>
<text x="300" y="235" text-anchor="middle" fill="#6366f1" font-weight="bold" font-size="20">BOX 1</text>
<text x="300" y="275" text-anchor="middle" fill="#888" font-size="16">Description</text>

<rect x="580" y="170" width="440" height="160" rx="20" fill="rgba(139,92,246,0.12)" stroke="#8b5cf6" stroke-width="2"/>
<text x="800" y="235" text-anchor="middle" fill="#8b5cf6" font-weight="bold" font-size="20">BOX 2</text>
<text x="800" y="275" text-anchor="middle" fill="#888" font-size="16">Description</text>

<rect x="80" y="390" width="440" height="160" rx="20" fill="rgba(16,185,129,0.12)" stroke="#10b981" stroke-width="2"/>
<text x="300" y="455" text-anchor="middle" fill="#10b981" font-weight="bold" font-size="20">BOX 3</text>
<text x="300" y="495" text-anchor="middle" fill="#888" font-size="16">Description</text>

<rect x="580" y="390" width="440" height="160" rx="20" fill="rgba(245,158,11,0.12)" stroke="#f59e0b" stroke-width="2"/>
<text x="800" y="455" text-anchor="middle" fill="#f59e0b" font-weight="bold" font-size="20">BOX 4</text>
<text x="800" y="495" text-anchor="middle" fill="#888" font-size="16">Description</text>
```
...
<rect x="150" y="170" width="800" height="80" rx="20" fill="rgba(99,102,241,0.12)" stroke="#6366f1" stroke-width="2"/>
<text x="200" y="220" text-anchor="start" fill="#6366f1" font-weight="bold" font-size="20">1.</text>
<text x="240" y="220" text-anchor="start" fill="#fff" font-size="18">First step description</text>
...
<text x="170" y="260" text-anchor="middle" fill="#fff" font-size="18">Step 1</text>
...
<text x="450" y="260" text-anchor="middle" fill="#fff" font-size="18">Step 2</text>
...
<text x="730" y="260" text-anchor="middle" fill="#fff" font-size="18">Step 3</text>
...
<text x="970" y="260" text-anchor="middle" fill="#fff" font-size="18">Step 4</text>
```

### Circle Nodes (for concept maps)
```svg
<circle cx="200" cy="400" r="65" fill="rgba(59,130,246,0.3)" stroke="#3b82f6" stroke-width="2"/>
<text x="200" y="407" text-anchor="middle" fill="#3b82f6" font-weight="bold" font-size="18">Node 1</text>

<circle cx="550" cy="400" r="65" fill="rgba(236,72,153,0.3)" stroke="#ec4899" stroke-width="2"/>
<text x="550" y="407" text-anchor="middle" fill="#ec4899" font-weight="bold" font-size="18">Node 2</text>

<circle cx="900" cy="400" r="65" fill="rgba(16,185,129,0.3)" stroke="#10b981" stroke-width="2"/>
<text x="900" y="407" text-anchor="middle" fill="#10b981" font-weight="bold" font-size="18">Node 3</text>
```
...
<text x="550" y="55" text-anchor="middle" fill="#ffd700" font-weight="bold" font-size="34">KNOWLEDGE CHECK</text>
<rect x="150" y="120" width="800" height="180" rx="20" fill="rgba(99,102,241,0.1)" stroke="#6366f1" stroke-width="2"/>
<text x="550" y="180" text-anchor="middle" fill="#6366f1" font-weight="bold" font-size="22">CONCEPT NAME</text>
<text x="550" y="225" text-anchor="middle" fill="#fff" font-size="18">One-line summary</text>
...
<text x="300" y="250" font-size="24">This long sentence will overflow the box on both sides</text>

<!-- RIGHT: Split into lines, reduced font, proper padding -->
<rect x="100" y="200" width="400" height="120"/>
<text x="300" y="245" text-anchor="middle" font-size="16">This text is properly split</text>
<text x="300" y="275" text-anchor="middle" font-size="16">across two sized lines</text>
```
